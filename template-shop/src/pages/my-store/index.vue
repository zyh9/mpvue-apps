    ...
    export default {
        ...
        methods: {
            ...
            async shopInfoSum() {
                ...
                // console.log(this.shopInfoList.ShopTemplateId, '1 餐饮 2 电商') //1 餐饮 2 电商
            ...
            drawCanvas() {
                ...
                /* 店铺logo图片 */
                ctx.drawImage(this.shopInfoList.Logo, 160 * XS, 400 * XS, 20 * XS, 20 * XS)
                /* 二维码 */
            ...
            cache() {
                ...
                listItem.forEach(item => {
                    if (item.MultiSpec == 0) { //无规格
                        item.num = 0;
                        //空数组不会执行forEach，所以可省略针对this.cartListItem的length判断
